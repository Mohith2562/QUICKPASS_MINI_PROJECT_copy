...
const menuItems = [
    ...
    { label: 'Student Management', path: '/admin/student-management' },
    { label: 'Employee Management', path: '/admin/employee-management' },
    { label: 'Student-Teacher Assignments', path: '/admin/student-teacher-assignments' },
    { label: 'Teacher-HOD Assignments', path: '/admin/teacher-hod-assignments' },
    { label: 'System Reports', path: '/admin/system-reports' },
